...
export default class PriceAcceptForm extends Component<any, IStates> {
  ...
  componentDidMount() {
    this.context.socket.on("accept price order", this.updateAcceptPrice);
  }

  componentWillUnmount() {
    this.context.socket.off("accept price order", this.updateAcceptPrice);
  }
